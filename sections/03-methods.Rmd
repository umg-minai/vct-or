...
Balanced anaesthesia with VAs was given using Draeger Perseus A500 anaesthesia machines equipped with bypass vapourisers of the type Draeger D-Vapor 3000 (Draeger Medicine Deutschland GmbH, Luebeck, Germany).
...
We weighed the sevoflurane (SEVOrane, AbbVie Deutschland GmbH & Co. KG, Mainz, Germany) bottles before and after maximum filling of the vapouriser and used the difference in weight to record the sevoflurane consumption.
The vapourisers were filled to the maximum before we attached the first CONTRAfluran AGC (ZeoSys medical, Luckenwalde, Germany) and start our recordings.
During the study period the two vapourisers were filled completely and the sevoflurane bottle weight difference measured by the study team, which was not involved in the anaesthesia, almost every day.

In case a new bottle of sevoflurane was opened, it was initially attached to a non-study vapouriser to lose any excess pressure, subsequently it was weighed before the study vapouriser was filled.
...
Subsequently, we refilled the vapouriser to its maximum and measured the weight
difference of the sevoflurane bottle, again.
The weight difference was counted as consumption for the just exhausted AGC.

The weight gain of an AGC was determined by weighing the AGC before usage and after it was exhausted to determine in vivo mass transfer (ratio of absorber
...
The secondary outcomes were the difference between in vivo mass transfer and the recapture rate reported by ZeoSys, the difference in sevoflurane recovery between both ORs
