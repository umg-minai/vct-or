...
modify_header(
    label = "**Characteristics per canister**",
    stat_1 = "**OR1 (ENT)**, N = 15 canisters",
    stat_2 = "**OR2 (Neurosurgery)**, N = 5 canisters"
) |>
modify_caption(
    paste0(
        "Characteristics of all ", nrow(agc), " anaesthetic gas canisters. ",
        "Cases, durations, sevoflurane consumption, etc. are given as per canister. ",
