...
If the CONTRAfluran AGC was exhausted, visible by the red LED and warning signal of the SENSOfluran sensor unit (ZeoSys medical, Luckenwalde, Germany), the vapor was again filled to the maximum.
