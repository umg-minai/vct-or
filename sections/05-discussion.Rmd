...
the inhaled induction and the duration of anaesthesia are relevant differences.
...
of sevoflurane passes the patients without uptake, thus increasing the amount
that can be captured by the AGC and yielding higher capture efficiency.
