...
## Comparing sevoflurane consumption measurements {#cmp-msrmts}
...
These four cases yield a calculated consumption of `r sprintf("%.2f g", AGC14EstimatedUsedWeightSev)` sevoflurane.
...
for our anaesthetic gas canister CH0100012088
