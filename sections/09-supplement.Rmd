        ...
        caption = paste0(
            ...
            paste0(
                c(
                    ...
                    "C~avg~: average used sevoflurane [g.h^-1^]",
                    "D: total duration [h]",
...
After changing the last AGC *CH0100012088* in OR25 the vapor was not refilled.
Therefore we retrospectively calculate the sevoflurane consumption for the
last four anaesthesia cases using the user log entry provided by the Draeger
...
knitr::kable(
    col.names = c("Case", "Time since vapor opened [min]", "Fresh gas flow [l.min^-1^]",
                  "Vapor [Vol%]", "Duration [min]",
