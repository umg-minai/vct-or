...
We saw a weight loss over time of around
`r round(fit.weigth.loss$coefficients * 1000)` mg per day per absorber during
storage.

**Conclusions**:
If CONTRAfluran^TM^ absorbers are used until they are fully saturated,
almost half of the sevoflurane can be recaptured, but
the capture efficiency depends on the fresh gas flow used and duration of
anaesthesia.
