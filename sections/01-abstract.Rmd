...
capture efficiency of the CONTRAfluran absorbers for sevoflurane
in a 'real-world' scenario.

**Methods**:
In this prospective single-center study we collected
...
saturation levels.
After storage and transport, sevoflurane was recaptured from the absorbers by
the absorber manufacturer ZeoSys.
...
absorbers, whihc was obtained by
comparing the weight
of the sevoflurane bottles before versus after refilling the vapourisers.
...
`r .tbl(tbl_weights, "ProportionalCaptureEfficiency", column = "stat_1", pattern = "{median} %")` in the OR with shorter anaesthesia durations and frquent inhaled induction
versus
...
**Conclusions**:
If CONTRAfluran absorbers are used until they are fully saturated,
almost half of the sevoflurane can be recaptured, but
the capture efficiency depends on fresh gas flow used and duration of
anaesthesia.
